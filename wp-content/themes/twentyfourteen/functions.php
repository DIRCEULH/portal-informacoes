...
//Joga o login na tela ao usuario colaborador logar se
...
//remove tela de usuario no inicio do menuadd_action('after_setup_theme', 'remove_admin_bar');
...
//Remove admin_bar do usuario Loja (colaborador)
...
// Remover o link perdi a senha da tela de login
function remove_lostpassword_URL ( $text ) {
if ($text == 'Perdeu a senha?'){$text = '';}
return $text;
}
add_filter( 'gettext', 'remove_lostpassword_URL' );
