...
$activation_time = get_option( 'zoooom_activation_time');

$show_discount = false;
if ( time() - 3*86400 < $activation_time ) {
    $show_discount = true;
}

$start_date = date('j M', $activation_time - 3*86400 );
$end_date = date('j M', $activation_time + 2*86400 );
...
$offer_link = 'https://www.silkypress.com/wp-image-zoom-plugin/?a=' . iz_convert_numbers_letters( $activation_time );
...
<div id="right_column_metaboxes">
    ...
    <h3><img src="<?php echo site_url(); ?>/wp-content/plugins/wp-image-zoooom/assets/images/icon.svg" /> <?php _e('WP Image Zoooom Pro'); ?></h3>
    </div>
        ...
        <p style="text-align: center;">
            <a href="<?php echo $offer_link; ?>" target="_blank" class="button" rel="noreferrer"><?php _e('Upgrade to PRO'); ?></a>
        </p>
        </div> 
    </div>   
    <?php endif; ?>
