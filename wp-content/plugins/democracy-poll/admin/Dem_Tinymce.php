...
class Dem_Tinymce {
	...
	static function tinymce_l10n( $mce_l10n ) {
		$l10n = array_map('esc_js', array(
			'Insert Poll of Democracy' => __('Insert Poll of Democracy', 'dem'),
			'Insert Poll ID' => __('Insert Poll ID', 'dem'),
			'Error: ID is a integer. Enter ID again, please.' => __('Error: ID is a integer. Enter ID again, please.', 'dem'),
		) );
