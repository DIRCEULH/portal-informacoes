...
### Does this app have an uninstall funtion? Does it work cleanly?

Yes it have! To completely uninstall the plugin, deactivate it and then press "delete" link in admin plugins page.
...
* ADD: add exact time when poll will closed...
